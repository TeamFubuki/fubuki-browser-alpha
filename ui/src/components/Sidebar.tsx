...
export default function Sidebar() {
  ...
  return (
    <aside classList={{ sidebar: true, resizing: resizing() }} aria-label={t("common.tabs", browserState.settings.language)}>
      <div class="sidebar-drag-area" />
      <button class="new-tab-button" title={t("common.newTab", browserState.settings.language)} aria-label={t("common.newTab", browserState.settings.language)} onClick={() => void invokeBridge("tabs.create", { active: true })}>
