...
std::string PageChrome(const std::string& title, const std::string& body) {
  ...
  html << "<!doctype html><html lang=\"" << HtmlEscape(lang) << "\" data-appearance=\""
       << HtmlEscape(appearance) << "\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" "
          "content=\"width=device-width,initial-scale=1\"><title>"
       << HtmlEscape(Label(title)) << "</title>" << FubukiFaviconLink() << R"(<style>
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;min-height:100vh;background:radial-gradient(circle at 12% -10%,rgb(69 147 255/.09),transparent 34%),radial-gradient(circle at 92% 4%,rgb(255 137 118/.08),transparent 30%),var(--bg);color:var(--text);font:14px -apple-system,BlinkMacSystemFont,"SF Pro Text","Hiragino Sans","Hiragino Kaku Gothic ProN","Yu Gothic","Helvetica Neue",sans-serif;letter-spacing:0;--bg:#f5f7fa;--surface:rgb(255 255 255/.92);--surface-2:#edf1f6;--text:#15171a;--muted:#66707c;--line:rgb(22 28 36/.11);--hover:rgb(22 28 36/.05);--active:rgb(28 101 242/.1);--accent:#1f6feb;--danger:#b42318;--shadow:0 8px 24px rgb(18 32 52/.055),0 1px 2px rgb(18 24 32/.06)}
...
main{width:min(1060px,calc(100vw - 48px));margin:0 auto;padding:40px 0 64px;animation:pageIn .32s cubic-bezier(.2,.8,.2,1)}header{display:flex;align-items:center;gap:14px;margin-bottom:28px}.logo{width:38px;height:38px;filter:drop-shadow(0 5px 10px rgb(80 115 180/.16))}h1{font-size:30px;line-height:1.08;margin:0;font-weight:740;letter-spacing:-.025em}h2{font-size:13px;margin:14px 0 5px;color:var(--muted);font-weight:680}a{color:inherit}.list{display:grid;gap:9px}.row{min-height:56px;display:grid;grid-template-columns:24px minmax(0,1fr) auto;align-items:center;gap:12px;padding:11px 13px;border:1px solid var(--line);border-radius:12px;background:var(--surface);box-shadow:var(--shadow);text-decoration:none;animation:rowIn .28s cubic-bezier(.2,.8,.2,1);transition:background .16s ease,border-color .16s ease,transform .16s ease,box-shadow .16s ease}.row:hover{background:color-mix(in srgb,var(--surface) 88%,var(--accent));border-color:color-mix(in srgb,var(--line) 52%,var(--accent));transform:translateY(-1px);box-shadow:0 10px 28px rgb(18 32 52/.09)}.row>a{min-width:0;text-decoration:none}.favicon{width:18px;height:18px;border-radius:5px;background:linear-gradient(135deg,#25a8d7,#6d7edc 58%,#f08072)}.favicon img{width:18px;height:18px;border-radius:5px}.title{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:650}.meta{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted);font-size:12px;line-height:1.45}.download-main{display:grid;gap:5px;min-width:0}.download-status{display:flex;align-items:center;gap:8px;color:var(--muted);font-size:12px;line-height:1.35}.download-bar{position:relative;overflow:hidden;width:min(260px,42vw);height:5px;border-radius:999px;background:var(--surface-2)}.download-bar span{position:absolute;inset:0 auto 0 0;width:var(--progress);border-radius:inherit;background:linear-gradient(90deg,var(--accent),#7c8ff5);transition:width .18s ease}.button,.chip{min-height:34px;display:inline-grid;place-items:center;border:1px solid var(--line);border-radius:9px;padding:0 12px;background:var(--surface);color:var(--text);text-decoration:none;font:inherit;font-weight:630;transition:background .16s ease,border-color .16s ease,color .16s ease,transform .16s ease}.button:hover,.chip:hover{background:var(--hover);border-color:color-mix(in srgb,var(--line) 60%,var(--accent));transform:translateY(-1px)}.danger{color:var(--danger)}.disabled{color:var(--muted);opacity:.55;cursor:not-allowed}.empty{color:var(--muted);padding:28px 20px;border:1px dashed var(--line);border-radius:12px;text-align:center;background:var(--surface)}.section{display:grid;gap:16px}.field{display:grid;gap:12px;padding:18px;border:1px solid var(--line);border-radius:12px;background:var(--surface);box-shadow:var(--shadow);animation:rowIn .28s cubic-bezier(.2,.8,.2,1);scroll-margin-top:18px}.field>span{font-size:15px;font-weight:700}.segmented{display:flex;flex-wrap:wrap;gap:8px}.selected{border-color:color-mix(in srgb,var(--accent) 70%,var(--line));background:var(--active);color:var(--accent)}input{height:38px;min-width:220px;border:1px solid var(--line);border-radius:9px;padding:0 11px;background:var(--surface);color:var(--text);font:inherit;outline:0;transition:border-color .16s ease,box-shadow .16s ease,background .16s ease}input:focus{border-color:var(--accent);box-shadow:0 0 0 3px color-mix(in srgb,var(--accent) 14%,transparent)}.inline-form{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.settings-layout{display:grid;grid-template-columns:220px minmax(0,1fr);gap:20px;align-items:start}.settings-nav{position:sticky;top:20px;display:grid;gap:3px;padding:9px;border:1px solid var(--line);border-radius:12px;background:var(--surface);box-shadow:var(--shadow)}.settings-nav a{min-height:36px;display:flex;align-items:center;padding:0 11px;border-radius:8px;color:var(--muted);font-weight:640;text-decoration:none;transition:background .16s ease,color .16s ease,transform .16s ease}.settings-nav a:hover{background:var(--hover);color:var(--text);transform:translateX(2px)}.settings-content{display:grid;gap:16px}.settings-search{margin-bottom:0}.settings-search input{width:100%;background:var(--surface)}.section-kicker{color:var(--muted);font-size:12px;line-height:1.5}.switch-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:center}@media(max-width:760px){main{width:min(100% - 28px,1060px);padding-top:26px}.settings-layout{grid-template-columns:1fr}.settings-nav{position:static;grid-template-columns:repeat(2,minmax(0,1fr))}input{min-width:0;width:100%}.row{grid-template-columns:20px minmax(0,1fr)}.download-bar{width:100%}}@media(max-width:460px){main{width:calc(100% - 20px)}header{margin-bottom:20px}.settings-nav{grid-template-columns:1fr}.row{padding:10px}.row>form{grid-column:2}}@media(prefers-reduced-motion:reduce){*,*::before,*::after{animation:none!important;scroll-behavior:auto!important;transition:none!important}}
html[data-appearance=dark] body{--bg:#14161a;--surface:#1d2025;--surface-2:#252932;--text:#f4f6f8;--muted:#a7b0bd;--line:rgb(255 255 255/.12);--hover:rgb(255 255 255/.07);--active:rgb(111 168 255/.14);--accent:#76a9ff;--danger:#ff8a80;--shadow:none;color-scheme:dark}
...
std::string NewTabHtml() {
  ...
  html
      ...
      << HtmlEscape(appearance) << R"("><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>)" << Label("New Tab")
      << R"(</title>)" << FubukiFaviconLink() << R"(<style>
*{box-sizing:border-box}html,body{height:100%}@keyframes pageIn{from{opacity:0;transform:translateY(12px)}to{opacity:1;transform:translateY(0)}}body{margin:0;display:grid;place-items:center;background:radial-gradient(circle at 20% 18%,rgb(52 144 255/.12),transparent 34%),radial-gradient(circle at 82% 20%,rgb(255 133 113/.1),transparent 32%),#f5f7fa;color:#15171a;font:15px -apple-system,BlinkMacSystemFont,"SF Pro Text","Hiragino Sans","Hiragino Kaku Gothic ProN","Yu Gothic","Helvetica Neue",sans-serif;letter-spacing:0}html[data-appearance=dark] body{background:radial-gradient(circle at 20% 18%,rgb(52 144 255/.12),transparent 34%),radial-gradient(circle at 82% 20%,rgb(255 133 113/.08),transparent 32%),#14161a;color:#f4f6f8;color-scheme:dark}main{width:min(660px,calc(100vw - 40px));display:grid;gap:22px;justify-items:center;animation:pageIn .38s cubic-bezier(.2,.8,.2,1)}.logo{width:68px;height:68px;filter:drop-shadow(0 10px 18px rgb(80 115 180/.2))}h1{margin:0;font-size:34px;line-height:1;font-weight:740;letter-spacing:-.035em}form{position:relative;width:100%}form::before{content:'⌕';position:absolute;z-index:1;left:17px;top:50%;transform:translateY(-52%);color:#788290;font-size:20px;pointer-events:none}input{width:100%;height:52px;border:1px solid rgb(24 32 44/.12);border-radius:14px;background:rgb(255 255 255/.94);box-shadow:0 14px 40px rgb(20 35 60/.09),0 2px 6px rgb(20 35 60/.05);padding:0 18px 0 46px;color:inherit;font:inherit;outline:0;transition:border-color .16s ease,box-shadow .16s ease,background .16s ease,transform .16s ease}html[data-appearance=dark] input{background:rgb(29 32 37/.94);border-color:rgb(255 255 255/.12);color:#f4f6f8;box-shadow:0 16px 44px rgb(0 0 0/.22)}@media(prefers-color-scheme:dark){html[data-appearance=system] body{background:radial-gradient(circle at 20% 18%,rgb(52 144 255/.12),transparent 34%),radial-gradient(circle at 82% 20%,rgb(255 133 113/.08),transparent 32%),#14161a;color:#f4f6f8;color-scheme:dark}html[data-appearance=system] input{background:rgb(29 32 37/.94);border-color:rgb(255 255 255/.12);color:#f4f6f8;box-shadow:0 16px 44px rgb(0 0 0/.22)}}input:focus{border-color:#3b82f6;box-shadow:0 0 0 4px rgb(59 130 246/.13),0 18px 48px rgb(20 35 60/.12);transform:translateY(-1px)}@media(max-width:480px){main{width:calc(100vw - 28px)}.logo{width:58px;height:58px}h1{font-size:28px}}@media(prefers-reduced-motion:reduce){*,*::before,*::after{animation:none!important;transition:none!important}}html[data-appearance=dark] body{background:radial-gradient(circle at 20% 18%,rgb(52 144 255/.12),transparent 34%),radial-gradient(circle at 82% 20%,rgb(255 133 113/.08),transparent 32%),#14161a;color:#f4f6f8;color-scheme:dark}html[data-appearance=dark] input{background:rgb(29 32 37/.94);border-color:rgb(255 255 255/.12);color:#f4f6f8}
